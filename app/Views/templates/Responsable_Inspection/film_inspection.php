...
<body>
    ...
    <header class="navbar">
        ...
        <nav>
            <ul>
                <li><a href="/dashboard_inspection">Accueil</a></li>
                <li><a href="/film_inspection" class="active">Films</a></li>
                <li><a href="/planning_inspection">Planning</a></li>
                <li><a href="/resultats_inspection">Résultats</a></li>
            </ul>
        </nav>
        <div class="nav-right">
    ...
    <main>
        <section class="films-section">
            ...
            <a href="/ajouter-documentaire"><button id="add-user-btn" class="bouton">+ Ajouter un Documentaire</button></a>

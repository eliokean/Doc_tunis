...
<body>
    ...
    <script>
        ...
        // Sélectionner le conteneur pour le défilement horizontal
        ...
        const autoScroll = () => {
            ...
            if (storyContainer.scrollLeft >= maxScrollLeft) {
        ...
        // Activer le défilement automatique toutes les 3 secondes
